"""Config flow for Solity LAVO Smart Lock."""
...
from .api import (
    ...
    SolityApiClientCommunicationError,
    SolityApiClientError,
)
from .const import DOMAIN, LOGGER


class SolityFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for Solity LAVO Smart Lock."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                _errors["base"] = "auth"
            except SolityApiClientCommunicationError as exception:
                ...
                return self.async_create_entry(
                    title=f"Solity ({user_input[CONF_USERNAME]})",
                    data=user_input,
                )
